...
| [07_enterprise_rag_systems_senior_principal_assessment.md](file:///Users/toanbui/dev/data_ai_engineer/questions/07_enterprise_rag_systems_senior_principal_assessment.md) | **Enterprise RAG Systems Assessment** | Deep-dive assessment for Senior & Principal Data Engineers on production-grade RAG (Layout-aware parsing, Parent-Child chunking, Hybrid BM25+Dense search, Zero-trust ACL trimming, DiskANN/Quantization FinOps, Zero-downtime model migration). |
